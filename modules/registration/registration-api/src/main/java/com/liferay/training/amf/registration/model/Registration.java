 ...
 * @generated
 */
@ImplementationClassName("com.liferay.training.amf.registration.model.impl.RegistrationImpl")
@ProviderType
public interface Registration extends RegistrationModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.liferay.training.amf.registration.model.impl.RegistrationImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Registration, Long> USER_ID_ACCESSOR = new Accessor<Registration, Long>() {
			@Override
