...
public class RegistrationServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<RegistrationService, RegistrationService> serviceTracker = new ServiceTracker<RegistrationService, RegistrationService>(bundle.getBundleContext(),
				RegistrationService.class, null);
