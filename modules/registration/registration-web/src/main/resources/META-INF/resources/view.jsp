...
<liferay-frontend:edit-form-header>

	<p>
		<br>
		<b><liferay-ui:message key="registration.caption" /></b><br>
	</p>

</liferay-frontend:edit-form-header>

<portlet:actionURL name='addNewUser' var="myURL">
	<portlet:param name="param" value="Testing!" />
</portlet:actionURL>

<form action="<%=myURL%>" name="registrationForm" method="POST">
	<liferay-frontend:edit-form-body>

		<%--BASIC INFORMATION --%>
		<br>
		<b><liferay-ui:message key="registration.basicinfo" /></b>
		<br>
		...
		<aui:row>
			<aui:col width="50">
				...
				<aui:input label="Last Name" name="lastname" type="text"
					required="true" showRequiredLabel="true" />
				<aui:input label="Email Address" name="email" type="email"
					required="true" showRequiredLabel="true" />
			...
			<aui:col width="50">
				...
				<aui:input label="Confirm Password" name="confirmpassword"
					type="password" required="true" showRequiredLabel="true" />
				...
				%>
				<label> Birthday <liferay-ui:input-date name="dob"
						formName="Birthday"
		...
		<%--PHONE --%>
		<br>
		<b><liferay-ui:message key="registration.phone" /></b>
		<br>
		<aui:row>
		...
		<%--BILLING ADDRESS --%>
		<br>
		<b><liferay-ui:message key="registration.billingaddress" /></b>
		<br>
		<aui:row>
		...
		<%--SECURITY --%>
		<br>
		<b><liferay-ui:message key="registration.security" /></b>
		<br>
		<aui:select label="Security Question" name="securityquestion"
			required="true" showRequiredLabel="true" showEmptyOption="true">
...
<br />
		...
		<ol>
			<li><strong><u>Acceptance of Agreement</u></strong>.<br /> You
				...
				prior to using the Site. <br />
			<br /></li>
			<li><strong><u>Copyright</u></strong>.<br /> The content,
				...
				materials. <br />
			<br /></li>
			<li><strong><u>Service Marks</u></strong>.<br /> Products and
				names mentioned on the Site may be trademarks of their respective
				owners. <br />
			<br /></li>
			<li><strong><u>Limited Right to Use</u></strong>.<br /> The
				...
				redistribution). <br />
			<br /></li>
			<li><strong><u>Editing, Deleting and Modification</u></strong>.<br />

				We reserve the right in our sole discretion to edit or delete any
				documents, information or other content appearing on the Site. <br />
			<br /></li>
			<li><strong><u>Indemnification</u></strong>.<br /> You agree to
				...
				Site. <br />
			<br /></li>
			<li><strong><u>Nontransferable</u></strong>.<br /> Your right
				to use the Site is not transferable. Any password or right given to
				you to obtain information or documents is not transferable. <br />
			<br /></li>
			<li><strong><u>Disclaimer and Limits</u></strong>.<br /> THE
				INFORMATION FROM OR THROUGH THE SITE ARE PROVIDED &quot;AS-IS,&quot;
				...
				AND THE PRODUCTS, SERVICES, AND INFORMATION PRESENTED WOULD NOT BE
				PROVIDED WITHOUT SUCH LIMITATIONS. NO ADVICE OR INFORMATION, WHETHER
				ORAL OR WRITTEN, OBTAINED BY YOU FROM US THROUGH THE SITE SHALL
				...
				INTO ANY ATTORNEY-CLIENT RELATIONSHIP. <br />
			<br /> ALL RESPONSIBILITY OR LIABILITY FOR ANY DAMAGES CAUSED BY
				...
				PURCHASE PRICE YOU PAY FOR ANY GOODS, SERVICES OR INFORMATION. <br />
			<br /></li>
			<li><strong><u>Use of Information</u></strong>.<br /> We
				...
				communicated by you to us through the Site (collectively, the
				"Submission") will forever be the property of Acme Movie Fanatics.
				Acme Movie Fanatics will not be required to
				treat any Submission as confidential, and will not be liable for any
				ideas for its business (including without limitation, product,
				service or advertising ideas) and will not incur any liability as a
				result of any similarities that may appear in future Acme Movie Fanatics
				products, services or operations. Without limitation, Acme Movie Fanatics
				will have exclusive ownership of all present and future existing
				rights to the Submission of every kind and nature everywhere. Acme Movie Fanatics
				...
				whatever material you submit, and you, not Acme Movie Fanatics,
				have full responsibility for the message, including its legality,
				reliability, appropriateness, originality, and copyright. <br />
			<br /></li>
			<li><strong><u>Third-Party Services</u></strong>.<br /> We may
				allow access to or advertise third-party product or service
				...
				APPEARING ON MERCHANT SITES OR ANY OTHER SITE LINKED TO OUR SITE. <br />
			<br /></li>
			<li><strong><u>Third-Party Merchant Policies</u></strong>.<br />
				...
				the other. <br />
			<br /></li>
			<li><strong><u>Privacy Policy</u></strong>.<br /> Our Privacy
				Policy, as it may change from time to time, is a part of this
				Agreement. <br />
			<br /></li>
			<li><strong><u>Payments</u></strong>.<br /> You represent and
				...
				you at the posted prices, including any applicable taxes. <br />
			<br /></li>
			<li><strong><u>Securities Laws</u></strong>.<br /> This Site
				...
				filings or documents. <br />
			<br /></li>
			<li><strong><u>Links to Other Web Sites</u></strong>.<br /> The
				...
				our Site does not imply approval or endorsement of the linked web
				site by us. If you decide to leave our Site and access these
				third-party sites, you do so at your own risk. <br />
			<br /></li>
			<li><strong><u>Copyrights and Copyright Agents</u></strong>.<br />
				...
				Copyright Agent the following information: <br />
			<br /> (a) An electronic or physical signature of the person
				authorized to act on behalf of the owner of the copyright interest;

				<br />
			<br /> (b) A description of the copyrighted work that you claim has
				been infringed; <br />
			<br /> (c) A description of where the material that you claim is
				infringing is located on the Site; <br />
			<br /> (d) Your address, telephone number, and email address; <br />
			<br /> (e) A statement by you that you have a good faith belief that
				the disputed use is not authorized by the copyright owner, its
				agent, or the law; and <br />
			<br /> (f) A statement by you, made under penalty of perjury, that
				...
				infringement on the Site can be reached by directing an e-mail to
				the Copyright Agent at amf@liferay.com.

				<br />
			<br /></li>
			<li><strong><u>Proposed Product and Service
						Offerings</u></strong>.<br /> All descriptions of proposed products and
				services are based on assumptions subject to change and you should
				not rely on the availability or functionality of products or
				services until they are actually offered through the Site. We
				reserve the right in its sole discretion to determine how
				registration and other promotions will be awarded. This
				determination includes, without limitation, the scope, nature and
				timing of all such awards. <br />
			<br /></li>
			<li><strong><u>Information and Press Releases</u></strong>.<br />

				The Site contains information and press releases about us. While
				this information was believed to be accurate as of the date
				...
				relied upon as being provided or endorsed by us. <br />
			<br /></li>
			<li><strong><u>Miscellaneous</u></strong>.<br /> This Agreement
				shall be treated as though it were executed and performed in Los
				Angeles, CA, and shall be governed by and construed in accordance
				...
				shall be brought solely in Los Angeles, CA. You expressly submit to
				the exclusive jurisdiction of said courts and consents to
				...
				in or associated with the Site is in conflict or inconsistent with
				this Agreement, this Agreement shall take precedence. Our failure to
				enforce any provision of this Agreement shall not be deemed a waiver
				of such provision nor of the right to enforce such provision.<br />
			</li>
		</ol>


		<aui:input label="registration.termsofuse" name="tou" type="checkbox"
			required="true" showRequiredLabel="true" />
