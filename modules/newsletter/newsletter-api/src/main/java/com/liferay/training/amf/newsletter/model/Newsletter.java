 ...
 * @generated
 */
@ImplementationClassName("com.liferay.training.amf.newsletter.model.impl.NewsletterImpl")
@ProviderType
public interface Newsletter extends NewsletterModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.liferay.training.amf.newsletter.model.impl.NewsletterImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Newsletter, Long> NEWSLETTER_ID_ACCESSOR = new Accessor<Newsletter, Long>() {
			@Override
