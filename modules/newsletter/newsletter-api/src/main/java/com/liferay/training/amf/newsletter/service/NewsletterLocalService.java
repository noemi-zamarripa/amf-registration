...
public interface NewsletterLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NewsletterLocalServiceUtil} to access the newsletter local service. Add custom service methods to {@link com.liferay.training.amf.newsletter.service.impl.NewsletterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public String getByline(List<Newsletter> news)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JournalArticle> getJournalArticles(List<Newsletter> news)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public String getTabs(List<Integer> years)
		throws DocumentException, PortalException;
