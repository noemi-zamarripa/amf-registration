 ...
 */
@ProviderType
public class StoreEventsServiceWrapper implements StoreEventsService,
	ServiceWrapper<StoreEventsService> {
	...
	public boolean checkPermissions(long groupId, String resourceName,
		...
		return _storeEventsService.checkPermissions(groupId, resourceName,
			primaryKey, actionId);
	}
