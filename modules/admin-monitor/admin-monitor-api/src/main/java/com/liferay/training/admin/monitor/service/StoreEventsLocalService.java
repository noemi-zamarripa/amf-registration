...
public interface StoreEventsLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StoreEventsLocalServiceUtil} to access the store events local service. Add custom service methods to {@link com.liferay.training.admin.monitor.service.impl.StoreEventsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StoreEvents> getEventsByUser(String eventType, long userId,
		int start, int end);
	...
	*/
	...
	public void setEventFields(User user, StoreEvents storeEvent,
		String eventType);
