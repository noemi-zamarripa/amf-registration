...
<aui:form action="${lookupZipURL}" method="post">
	<aui:input label="Enter US Zip" name="enter-us-zip" type="text" value="${enteredZip}" >
		...
		<aui:validator name="maxLength" errorMessage="Length must be 5.">5</aui:validator>
		<aui:validator name="minLength" errorMessage="Length must be 5.">5</aui:validator>
	</aui:input>
