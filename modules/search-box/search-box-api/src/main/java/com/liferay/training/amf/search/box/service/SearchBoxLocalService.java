...
public interface SearchBoxLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SearchBoxLocalServiceUtil} to access the search box local service. Add custom service methods to {@link com.liferay.training.amf.search.box.service.impl.SearchBoxLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SearchBox> getSearchBoxs(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SearchBox> getSearchBoxsByUuidAndCompanyId(String uuid,
		long companyId);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<User> getUsersFromIds(List<Long> userIds)
		throws PortalException;
