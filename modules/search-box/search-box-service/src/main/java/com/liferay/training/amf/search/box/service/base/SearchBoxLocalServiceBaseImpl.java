...
package com.liferay.training.amf.search.box.service.base;
...
/**
 * Provides the base implementation for the search box local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.training.amf.search.box.service.impl.SearchBoxLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class SearchBoxLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SearchBoxLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.training.amf.search.box.service.SearchBoxLocalServiceUtil} to access the search box local service.
	 */
	...
	public SearchBox addSearchBox(SearchBox searchBox) {
		...
		return searchBoxPersistence.update(searchBox);
	}
	...
	public SearchBox createSearchBox(long fooId) {
		return searchBoxPersistence.create(fooId);
	}
	...
	public SearchBox deleteSearchBox(long fooId) throws PortalException {
		return searchBoxPersistence.remove(fooId);
	}
	...
	public SearchBox deleteSearchBox(SearchBox searchBox) {
		return searchBoxPersistence.remove(searchBox);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SearchBox.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return searchBoxPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return searchBoxPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return searchBoxPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SearchBox fetchSearchBox(long fooId) {
		return searchBoxPersistence.fetchByPrimaryKey(fooId);
	}
	...
	public SearchBox fetchSearchBoxByUuidAndGroupId(String uuid, long groupId) {
		return searchBoxPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public SearchBox getSearchBox(long fooId) throws PortalException {
		return searchBoxPersistence.findByPrimaryKey(fooId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(searchBoxLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SearchBox.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(searchBoxLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SearchBox.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<SearchBox>() {
				@Override
				public void performAction(SearchBox searchBox)
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(SearchBox.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return searchBoxLocalService.deleteSearchBox((SearchBox)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return searchBoxPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SearchBox> getSearchBoxsByUuidAndCompanyId(String uuid,
		long companyId) {
		return searchBoxPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<SearchBox> getSearchBoxsByUuidAndCompanyId(String uuid,
		...
		return searchBoxPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public SearchBox getSearchBoxByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return searchBoxPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<SearchBox> getSearchBoxs(int start, int end) {
		return searchBoxPersistence.findAll(start, end);
	}
	...
	public int getSearchBoxsCount() {
		return searchBoxPersistence.countAll();
	}
	...
	/**
	 * Returns the search box local service.
	 *
	 * @return the search box local service
	 */
	public SearchBoxLocalService getSearchBoxLocalService() {
		return searchBoxLocalService;
	}

	/**
	 * Sets the search box local service.
	 *
	 * @param searchBoxLocalService the search box local service
	 */
	public void setSearchBoxLocalService(
		SearchBoxLocalService searchBoxLocalService) {
		this.searchBoxLocalService = searchBoxLocalService;
	}

	/**
	 * Returns the search box persistence.
	 *
	 * @return the search box persistence
	 */
	public SearchBoxPersistence getSearchBoxPersistence() {
		return searchBoxPersistence;
	}

	/**
	 * Sets the search box persistence.
	 *
	 * @param searchBoxPersistence the search box persistence
	 */
	public void setSearchBoxPersistence(
		SearchBoxPersistence searchBoxPersistence) {
		this.searchBoxPersistence = searchBoxPersistence;
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.training.amf.search.box.model.SearchBox",
			searchBoxLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.training.amf.search.box.model.SearchBox");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SearchBoxLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = searchBoxPersistence.getDataSource();
	...
	@BeanReference(type = SearchBoxLocalService.class)
	protected SearchBoxLocalService searchBoxLocalService;
	@BeanReference(type = SearchBoxPersistence.class)
	protected SearchBoxPersistence searchBoxPersistence;
