 ...
 */
@ProviderType
public class SearchBoxCacheModel implements CacheModel<SearchBox>,
	Externalizable {
	@Override
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SearchBoxCacheModel)) {
			return false;
		}

		SearchBoxCacheModel searchBoxCacheModel = (SearchBoxCacheModel)obj;
