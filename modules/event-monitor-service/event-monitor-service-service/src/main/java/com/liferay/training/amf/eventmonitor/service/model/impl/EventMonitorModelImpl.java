...
import com.liferay.training.amf.eventmonitor.service.model.EventMonitorModel;
...
/**
 * The base model implementation for the EventMonitor service. Represents a row in the &quot;EventMonitor_EventMonitor&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link EventMonitorModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link EventMonitorImpl}.
 * </p>
 *
...
public class EventMonitorModelImpl extends BaseModelImpl<EventMonitor>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a event monitor model instance should use the {@link EventMonitor} interface instead.
	 */
	public static final String TABLE_NAME = "EventMonitor_EventMonitor";
	...
	public static final String TABLE_SQL_CREATE = "create table EventMonitor_EventMonitor (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table EventMonitor_EventMonitor";
	public static final String ORDER_BY_JPQL = " ORDER BY eventMonitor.field1 ASC";
	public static final String ORDER_BY_SQL = " ORDER BY EventMonitor_EventMonitor.field1 ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.amf.eventmonitor.service.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.training.amf.eventmonitor.service.model.EventMonitor"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.amf.eventmonitor.service.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.training.amf.eventmonitor.service.model.EventMonitor"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.training.amf.eventmonitor.service.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.training.amf.eventmonitor.service.model.EventMonitor"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.training.amf.eventmonitor.service.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.training.amf.eventmonitor.service.model.EventMonitor"));
	...
	public Object clone() {
		...
		eventMonitorImpl.setUuid(getUuid());
		eventMonitorImpl.setFooId(getFooId());
		eventMonitorImpl.setGroupId(getGroupId());
		...
		eventMonitorImpl.setModifiedDate(getModifiedDate());
		eventMonitorImpl.setField1(getField1());
		eventMonitorImpl.setField2(isField2());
		eventMonitorImpl.setField3(getField3());
		eventMonitorImpl.setField4(getField4());
		eventMonitorImpl.setField5(getField5());
	...
	public int compareTo(EventMonitor eventMonitor) {
		...
		value = getField1().compareTo(eventMonitor.getField1());
	...
	public void resetOriginalValues() {
		...
		eventMonitorModelImpl._originalUuid = eventMonitorModelImpl._uuid;

		eventMonitorModelImpl._originalGroupId = eventMonitorModelImpl._groupId;

		eventMonitorModelImpl._setOriginalGroupId = false;

		eventMonitorModelImpl._originalCompanyId = eventMonitorModelImpl._companyId;

		eventMonitorModelImpl._setOriginalCompanyId = false;

		eventMonitorModelImpl._setModifiedDate = false;

		eventMonitorModelImpl._originalField2 = eventMonitorModelImpl._field2;

		eventMonitorModelImpl._setOriginalField2 = false;
	...
	public CacheModel<EventMonitor> toCacheModel() {
		...
		eventMonitorCacheModel.uuid = getUuid();

		String uuid = eventMonitorCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			eventMonitorCacheModel.uuid = null;
		}

		eventMonitorCacheModel.fooId = getFooId();

		eventMonitorCacheModel.groupId = getGroupId();
		...
		if (modifiedDate != null) {
			eventMonitorCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			eventMonitorCacheModel.modifiedDate = Long.MIN_VALUE;
		}

		eventMonitorCacheModel.field1 = getField1();

		String field1 = eventMonitorCacheModel.field1;

		if ((field1 != null) && (field1.length() == 0)) {
			eventMonitorCacheModel.field1 = null;
		}

		eventMonitorCacheModel.field2 = isField2();

		eventMonitorCacheModel.field3 = getField3();

		Date field4 = getField4();

		if (field4 != null) {
			eventMonitorCacheModel.field4 = field4.getTime();
		}
		else {
			eventMonitorCacheModel.field4 = Long.MIN_VALUE;
		}

		eventMonitorCacheModel.field5 = getField5();

		String field5 = eventMonitorCacheModel.field5;

		if ((field5 != null) && (field5.length() == 0)) {
			eventMonitorCacheModel.field5 = null;
		}
	...
	public String toXmlString() {
		...
		sb.append(
			"com.liferay.training.amf.eventmonitor.service.model.EventMonitor");
	...
	private static final ClassLoader _classLoader = EventMonitor.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			EventMonitor.class, ModelWrapper.class
		};
