 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.training.amf.eventmonitor.service.service.impl.StoreEventsLocalServiceImpl}.
 * </p>
 *
...
public abstract class StoreEventsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.training.amf.eventmonitor.service.service.StoreEventsLocalServiceUtil} to access the store events local service.
	 */
	...
	public StoreEvents createStoreEvents(long fooId) {
		return storeEventsPersistence.create(fooId);
	}
	...
	public StoreEvents deleteStoreEvents(long fooId) throws PortalException {
		return storeEventsPersistence.remove(fooId);
	}
	...
	public StoreEvents fetchStoreEvents(long fooId) {
		return storeEventsPersistence.fetchByPrimaryKey(fooId);
	}
	...
	public StoreEvents fetchStoreEventsByUuidAndGroupId(String uuid,
		long groupId) {
		return storeEventsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public StoreEvents getStoreEvents(long fooId) throws PortalException {
		return storeEventsPersistence.findByPrimaryKey(fooId);
	}
	...
	public StoreEvents getStoreEventsByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return storeEventsPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.training.amf.eventmonitor.service.model.StoreEvents",
