 ...
 */
@ProviderType
public interface SearchResultsPersistence extends BasePersistence<SearchResults> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<SearchResults> findByUuid(String uuid, int start,
		int end);
	...
	*/
	public java.util.List<SearchResults> findByUuid(String uuid, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<SearchResults> orderByComparator);
	...
	* @return the matching search resultses
	*/
	public java.util.List<SearchResults> findByUuid_C(String uuid,
		long companyId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, SearchResults> fetchByPrimaryKeys(
