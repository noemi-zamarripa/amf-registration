...
public interface SearchResultsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SearchResultsLocalServiceUtil} to access the search results local service. Add custom service methods to {@link com.liferay.training.amf.search.results.service.impl.SearchResultsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SearchResults fetchSearchResultsByUuidAndGroupId(String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SearchResults getSearchResultsByUuidAndGroupId(String uuid,
